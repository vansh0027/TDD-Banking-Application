...
public class TransferValidator {
	...
	public boolean firstIdValid(String s) {
		...
		if ((Account.getId(Integer.parseInt(arr[1])) instanceof Savings)
				|| (Account.getId(Integer.parseInt(arr[1])) instanceof Checking)) {
		...
		} else if (Account.getId(Integer.parseInt(arr[1])) instanceof CD) {
			return false;
		}
		return false;
	...
	public boolean secondIdValid(String s) {
		...
		if ((Account.getId(Integer.parseInt(arr[2])) instanceof Savings)
				|| (Account.getId(Integer.parseInt(arr[2])) instanceof Checking)) {
		...
		} else if (Account.getId(Integer.parseInt(arr[2])) instanceof CD) {
			return false;
		}
		return false;
	}
